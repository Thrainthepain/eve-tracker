...
# Last Updated: 2025-05-04 03:37:02
...
display_welcome_banner() {
    printf "${BLUE}╔═══════════════════════════════════════════════════════════════╗\n"
    printf "${BLUE}║                                                               ║\n"
    printf "${BLUE}║           ${GREEN}EVE Online Character Tracker - Docker Setup${BLUE}          ║\n"
    printf "${BLUE}║                                                               ║\n"
    printf "${BLUE}║  ${YELLOW}Created by: Thrainthepaindocker${BLUE}                             ║\n"
    printf "${BLUE}║  ${YELLOW}Last Updated: 2025-05-04 03:37:02${BLUE}                           ║\n"
    printf "${BLUE}║                                                               ║\n"
    printf "${BLUE}╚═══════════════════════════════════════════════════════════════╝${NC}\n"
}
