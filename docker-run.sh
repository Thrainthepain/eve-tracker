...
certbot certonly --webroot -w /var/www/certbot --email L E T S E N C R Y P T E M A I L − − a g r e e − t o s − − n o − e f f − e m a i l − d {DOMAIN} || echo "SSL setup failed or not needed";
else
